...
const Footer = () => {
    return (
        <>
            <section className="max-w-7xl mx-auto pb-[22px] px-6 py-12">
                <div className="bg-[url('/limon.png')] bg-cover bg-center rounded-2xl overflow-hidden p-10">
                    <div className="bg-white/80 box backdrop-blur-sm rounded-xl p-8 max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-6">
            ...
            <footer className="bg-white">
                <div className="w-full h-[60vh] flex items-center justify-center gap-20">
                    ...
                    <div className="text-center">
                        <div className="flex items-center justify-center gap-3 mb-4">
                            <img src="/Logo.png" alt="Organick logo" className="h-10" />
                        ...
                        <div className="flex items-center justify-center gap-4">
                            ...
                            <a className="w-9 h-9 box rounded-full bg-gray-100 flex items-center justify-center"><FaTwitter /></a>
                            <a className="w-9 h-9 box rounded-full bg-gray-100 flex items-center justify-center"><FaPinterest /></a>
                        </div>
                    </div>
                ...
                <div className="border-t ">
                    <div className="max-w-7xl mx-auto px-6 py-4 text-center text-sm text-gray-500">
                        <p>
                            ...
                            <a target="_blank" rel="noreferrer" href="https://t.me/tatu_talabasi_2" className="text-gray-600 font-bold hover:underline">
                                Murodillo
                            </a>
                        </p>
                    </div>
