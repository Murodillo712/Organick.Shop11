...
import mak from "../public/non2.png"; // Eslatma: "non2.png" nomi to'g'ri ekanligiga ishonch hosil qiling
...
export default function App() {
  const products = [
    ...
    { label: "Fresh", image: mak, name: "Zelco Suji Elaichi Rusk", oldPrice: 20.0, price: 15.0 }, // "imag" emas "image"
  ];
  ...
  return (
    <div className="font-sans">
      ...
      <section className="w-full h-[85vh] relative">
        <img src={foodImg} alt="Hero" className="absolute w-full inset-0 object-cover" />
      ...
      <section className="w-full h-[120vh] relative">
        ...
        <div className="relative pt-[100px] z-10 w-full flex flex-col items-center justify-start pl-[120px] h-full text-white text-center px-4">
          ...
          <div
            className="w-[100px] h-[100px] mt-[65px] bg-cover bg-center"
          ...
          <p className="text-[#274C5B] pt-[20px] text-[15px] italic">
          ...
          <div className="flex justify-around w-[800px] mt-[70px]">
            {[
              ...
              <span key={i} className="w-[150px] h-[150px] rounded-full border-[3px] border-[#7EB693] flex flex-col items-center justify-center">
                <h2 className="text-3xl md:text-4xl font-bold text-[#274C5B]">{item.value}</h2>
                <p className="text-[#274C5B] text-center text-[17px]">{item.label}</p>
              </span>
            ))}
          </div>
        </div>
        ...
        <div className="flex flex-col items-start justify-between w-[1100px] h-[64vh]">
          <div className="flex justify-between w-[1100px]">
            <div>
              ...
              <h1 className="text-[35px] font-bold leading-tight text-white">
          ...
          <div className="flex relative w-[1100px] h-[45vh] items-center justify-around z-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 justify-items-center">
              {rit.map((p, i) => (
                <Card key={i} {...p} />
              ))}
